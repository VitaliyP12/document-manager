        ...
        <div className="flex items-start justify-between p-6 border-b border-slate-700">
          <div className="flex items-start gap-3 flex-1 min-w-0">
            <div className="w-12 h-12 rounded-xl bg-slate-900 border border-slate-700 flex items-center justify-center flex-shrink-0">
              <FileIcon fileName={document.original_name} fileType={document.file_type} className="w-6 h-6" />
            </div>
              ...
              <div className="p-3 rounded-xl bg-slate-900 border border-slate-700">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-10 h-10 rounded-lg bg-slate-800 border border-slate-700 flex items-center justify-center flex-shrink-0">
                    <FileIcon fileName={document.original_name} fileType={document.file_type} className="w-5 h-5" />
                  </div>
                  <div className="flex-1 min-w-0">
